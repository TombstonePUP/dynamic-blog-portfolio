  ...
  return (
    <Link href="/" className={`flex items-center ${className}`}>
      <svg
        ...
        <path d="M15.8679 13.8303L10.0978 4.57405L14.185 14.0708L13.9445 22.4856L3.60634 25.3707L3.48613 26.0919L14.9062 22.9664L15.8679 13.8303Z" fill="#393E46" />
        <path d="M14.666 14.3114L14.3057 22.7264L3.60645 25.3709L4.92871 22.1248L9.49707 21.1629L8.53516 19.7205L3.24609 20.5623L0 12.9891L4.56836 11.3055L10.0977 4.57405L14.666 14.3114ZM7.33301 12.869L10.458 12.1473L8.1748 11.3055L7.33301 12.869Z" fill="#948979" />
      </svg>
    </Link>
  );
}
