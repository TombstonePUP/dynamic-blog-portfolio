      ...
      <div className="sticky top-0 z-10 flex items-center justify-between px-8 py-5 /80 backdrop-blur-md border-b ">
        <div className="flex items-center gap-2">
          <span className="text-[11px] font-black uppercase tracking-[0.2em] ">
            {previewAsset ? "Media Preview" : "Live Preview"}
          </span>
          {previewAsset && (
            <button
          ...
          <div className="flex flex-col items-center gap-8 pt-12">
            <div className="relative group">
              <Image
                ...
                height={800}
                unoptimized
                className="h-auto max-w-full bg-admin-bg shadow-[0_32px_64px_-12px_rgba(0,0,0,0.14)] ring-1"
              />
              <div className="mt-6 p-5 shadow-xl ring-1 text-center">
                <p className="text-sm font-black text-admin-text">
                  {previewAsset.filename}
                </p>
                <p className="text-[10px]  mt-1.5 uppercase font-bold tracking-widest">
                  Path: ./{previewAsset.filename}
                </p>
              </div>
            </div>
          </div>
